...
case "${1:-middleware}" in
  ...
  menu)       METHOD="KebbiBuild.BuildMenuApk" ;;          # 功能選單:一個功能一個按鈕,點選進入(輔導室/視覺/Live/G4/兩台對話)
  counselor)  METHOD="KebbiBuild.BuildCounselorApk" ;;     # 輔導室陪伴機器人:安全閘三層+真LLM開放聊+有聲/無聲(需 KEBBI_LLM_KEY/語音金鑰)
